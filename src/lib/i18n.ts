...
const resources = {
  en: {
    translation: {
      ...
      password: "Password",
      name: "Name",
      adminCode: "Admin Code (For Admin Registration Only)",
      adminCodeHint: "Leave empty to register as citizen. Admin code: ADMIN2025",
  ...
  hi: {
    translation: {
      ...
      password: "पासवर्ड",
      name: "नाम",
      adminCode: "एडमिन कोड (केवल एडमिन पंजीकरण के लिए)",
      adminCodeHint: "नागरिक के रूप में रजिस्टर करने के लिए खाली छोड़ें। एडमिन कोड: ADMIN2025",
  ...
  pa: {
    translation: {
      ...
      password: "ਪਾਸਵਰਡ",
      name: "ਨਾਮ",
      adminCode: "ਐਡਮਿਨ ਕੋਡ (ਸਿਰਫ ਐਡਮਿਨ ਰਜਿਸਟ੍ਰੇਸ਼ਨ ਲਈ)",
      adminCodeHint: "ਨਾਗਰਿਕ ਵਜੋਂ ਰਜਿਸਟਰ ਕਰਨ ਲਈ ਖਾਲੀ ਛੱਡੋ। ਐਡਮਿਨ ਕੋਡ: ADMIN2025",
